...
Revision ID: acd6f57c7902
Revises: 
Create Date: 2021-07-13 20:44:25.085817
...
def upgrade():
    ...
    sa.Column('activity_date', sa.TIMESTAMP(timezone=False), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('attendance_date', sa.TIMESTAMP(timezone=False), nullable=False),
