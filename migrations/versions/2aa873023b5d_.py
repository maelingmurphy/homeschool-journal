...
Revision ID: 2aa873023b5d
Revises: 
Create Date: 2021-01-21 23:39:14.487049
...
def upgrade():
    ...
    with op.batch_alter_table('activity', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_activity_student_name'), ['student_name'], unique=False)
        batch_op.create_index(batch_op.f('ix_activity_subject_name'), ['subject_name'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('activity', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_activity_subject_name'))
        batch_op.drop_index(batch_op.f('ix_activity_student_name'))
